...
export default function Home() {
  ...
  const userO = { firstName: "Olena", lastName: "Dmytrenko" };
    ...
    <>
      <div className="py-5 text-center">
        <h1 className={styles.h1}>
          It feels great to <span className="text-primary"> pay.</span>
        </h1>
        <p>{user?.firstName} invited you to buy this product</p>
      </div>
      ...
      <div className="row g-5">
        ...
        <div className="col-md-7 col-lg-8">
          <div className="card">
            <div className="card-body">
              <h4 className="mb-3 fw-bold">Personal Info</h4>
